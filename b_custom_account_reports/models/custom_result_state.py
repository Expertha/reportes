...
class CustomResultState(models.Model):
	...
	def get_xlsx(self, options, response=None):
		...
		level_0_style = workbook.add_format({'font_name': 'Arial', 'bold': False, 'font_size': 11, 'bottom': 6, 'font_color': '#666666'})
		...
		level_2_style = workbook.add_format({'font_name': 'Arial', 'bold': False, 'font_size': 11, 'font_color': '#666666'})
		level_3_col1_style = workbook.add_format({'font_name': 'Arial', 'font_size': 12, 'font_color': '#666666', 'indent': 2})
		level_3_col1_total_style = workbook.add_format({'font_name': 'Arial', 'bold': False, 'font_size': 12, 'font_color': '#666666', 'indent': 1})
		...
		sheet.set_row(len(lines), 35)
		sheet.merge_range(35, 0, 35, 1, 'F _______________                      '
										'F_______________                        '
										'F _______________', signature_style)

		sheet.merge_range(36, 0, 36, 1, '            Rep. Legal                                                               '
										'Auditor                                                               '
										'Contador', '')
