...
class wizard_sv_general_final_report(models.TransientModel):
	_name = 'wizard.sv.general.final.report'
	...
	date_month = fields.Selection(
		[('1', 'Enero'), ('2', 'Febrero'), ('3', 'Marzo'), ('4', 'Abril'), ('5', 'Mayo'), ('6', 'Junio'),
		 ...
		 ('12', 'Diciembre')], string='Mes de facturación', default='3', required=True)
	...
	def print_general_final_report(self):
		datas = {'ids': self._ids,
				 'form': self.read()[0],
				 'model': 'wizard.sv.general.final.report'}
		return self.env.ref('financierosv_sucursal.report_general_final_pdf').report_action(self, data=datas)
